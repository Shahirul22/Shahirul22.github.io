...
export const projects: ProjectMeta[] = [
  ...
  {
    slug: 'procurement-compliance-system',
    title: 'Procurement & Compliance Management System',
    tagline: 'Full-lifecycle procurement system for a government agency — case wizard, committee decisions, objection handling.',
    stack: ['Laravel 13', 'PHP 8.3', 'MySQL', 'Spatie Permission', 'Pest 4', 'Playwright'],
    status: 'Live (private)',
    highlight: 'Enum-owned status transitions replace scattered status checks — one place decides what state a procurement case is allowed to move to next.',
    metrics: [
      { label: 'Models', value: '43' },
      { label: 'Controllers', value: '33' },
      { label: 'Migrations', value: '60' },
    ],
    category: 'Workflow / Compliance',
  },
  {
  ...
  {
    slug: 'iso-qms',
    title: 'ISO Quality Management System',
    tagline: 'Quality Management System for a local government authority’s ISO certification program.',
    stack: ['Laravel 9', 'PHP 8.0+', 'MySQL', 'Oracle (yajra/oci8)', 'Spatie Permission', 'Sanctum'],
    status: 'Live (private)',
    highlight: 'Watermarks every controlled-document download server-side against the clean source PDF, so the canonical file stays clean and every distributed copy is provably marked uncontrolled.',
    metrics: [
      { label: 'Base roles', value: '4' },
      { label: 'Audit types', value: '3' },
      { label: 'Data sources', value: '2' },
    ],
    category: 'Compliance / Quality Management',
  },
  {
    slug: 'it-service-management',
    title: 'IT Service Management System',
    tagline: 'Internal IT service management system for a Malaysian municipal council — complaints, provisioning requests and multi-level approvals.',
    stack: ['Laravel 11', 'PHP 8.2+', 'MySQL', 'Oracle (yajra/oci8)', 'Livewire 3', 'Spatie Permission'],
    status: 'Live (private)',
    highlight: 'One polymorphic approval table serves every request type through form_type/form_id morphing, so adding a new request module never requires a new approval schema.',
    metrics: [
      { label: 'Request types', value: '8' },
      { label: 'Roles', value: '13' },
      { label: 'Permissions', value: '150+' },
    ],
